...
struct mac_policy_ops {
    ...
    uint64_t mpo_proc_notify_exec_complete;
    ...
    uint64_t mpo_socket_check_ioctl;
    ...
    uint64_t mpo_vnode_check_lookup_preflight;
